...
class PagesTest(StudioCourseTest):
    ...
    def test_user_can_add_static_tab(self):
        ...
        """
        self.assertFalse(self.pages_page.is_static_page_present(), 'Static tab is visible')
        self.pages_page.add_static_page()
        self.assertTrue(self.pages_page.is_static_page_present(), 'Static tab is not visible')
    ...
    def test_user_can_edit_static_tab(self):
        ...
        """
        self.assertFalse(self.pages_page.is_static_page_present(), 'Static tab is not present')
        self.pages_page.add_static_page()
    ...
    def test_user_can_reorder_static_tabs(self):
        ...
        Scenario: Users can reorder static pages
            ...
            And I reload the page
                Then the static pages are switched
        """
        self.assertFalse(self.pages_page.is_static_page_present(), 'Static tab is present')
        self.pages_page.add_static_page()
        self.pages_page.click_edit_static_page()
